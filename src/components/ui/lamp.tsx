    ...
    >
      <div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center ">
        <motion.div
          ...
          className="bg-gradient-conic absolute inset-auto right-1/2 h-56 w-[30rem] overflow-visible from-[#435a7c] via-transparent to-transparent text-white [--conic-position:from_0deg_at_center_top]"
        >
        ...
        <motion.div
          initial={{ opacity: 0.5, width: "15rem", background: "white" }}
          whileInView={{ opacity: 1, width: "50rem", background: "white" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
          ...
          className="bg-gradient-conic absolute inset-auto left-1/2 h-56 w-[30rem] from-transparent via-transparent to-[#435a7c] text-white [--conic-position:from_-0deg_at_center_top]"
        >
